...
function AjoutQuestion(){
    ...
    //On crée un élément de type bouton
    var supG = document.createElement('img');
    supG.setAttribute("src",'img/cross.jpg');
    supG.setAttribute("style",'width:20px;float:right');
    supG.setAttribute("onclick",'SupDiv(groupe'+ idgroupe +')');
...
function AjoutRep(Id) {
    ...
    //On crée un élément de type bouton
    var supSG = document.createElement('img');
    supSG.setAttribute("src",'img/cross.jpg');
    supSG.setAttribute("style",'width:20px;float:right');
    supSG.setAttribute("onclick",'SupDiv(rep' + idrep + ')');
